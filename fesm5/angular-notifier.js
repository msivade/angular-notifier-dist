...
function NotifierNotificationComponent_ng_template_1_button_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function NotifierNotificationComponent_ng_template_1_button_2_Template_button_click_0_listener() { ɵɵrestoreView(_r5); var ctx_r4 = ɵɵnextContext(2); return ctx_r4.onClickDismiss(); });
    ɵɵnamespaceSVG();
...
function NotifierContainerComponent_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("ready", function NotifierContainerComponent_li_1_Template_notifier_notification_ready_1_listener($event) { ɵɵrestoreView(_r3); var ctx_r2 = ɵɵnextContext(); return ctx_r2.onNotificationReady($event); })("dismiss", function NotifierContainerComponent_li_1_Template_notifier_notification_dismiss_1_listener($event) { ɵɵrestoreView(_r3); var ctx_r4 = ɵɵnextContext(); return ctx_r4.onNotificationDismiss($event); });
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
